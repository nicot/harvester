...
# Read in config file
require './etc/config.rb' # Creates LogCheckConfig
...
file = LogCheckConfig.file
old_file = LogCheckConfig.old_file
matchers = LogCheckConfig.matchers
responders = LogCheckConfig.responders
